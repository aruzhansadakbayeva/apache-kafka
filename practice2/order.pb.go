...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\tpractice2\"X\n" +
	"\x04Item\x12\x1e\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\n" +
	"product_id\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x05R\bquantity\x12\x14\n" +
	"\x05price\x18\x03 \x01(\x01R\x05price\"\x86\x01\n" +
	"\x05Order\x12\x1a\n" +
	"\border_id\x18\x01 \x01(\tR\border_id\x12\x18\n" +
	"\auser_id\x18\x02 \x01(\tR\auser_id\x12%\n" +
	"\x05items\x18\x03 \x03(\v2\x0f.practice2.ItemR\x05items\x12 \n" +
	"\vtotal_price\x18\x04 \x01(\x01R\vtotal_priceB6Z4github.com/aruzhansadakbayeva/apache-kafka/practice2b\x06proto3"
...
var file_order_proto_goTypes = []any{
	(*Item)(nil),  // 0: practice2.Item
	(*Order)(nil), // 1: practice2.Order
}
var file_order_proto_depIdxs = []int32{
	0, // 0: practice2.Order.items:type_name -> practice2.Item
